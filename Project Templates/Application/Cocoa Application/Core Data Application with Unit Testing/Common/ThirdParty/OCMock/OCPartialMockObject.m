...
- (void) forwardToShadow: (NSInvocation *) invocation {
	id shadow = [_OCPartialMockShadowObjects objectForKey:[NSString stringWithCString:object_getClassName([invocation target]) encoding:NSASCIIStringEncoding]];
	[shadow forwardInvocation:invocation];
}
- (id) expect {
	OCMockObject *shadow = [_OCPartialMockShadowObjects objectForKey:[NSString stringWithCString:object_getClassName(self) encoding:NSASCIIStringEncoding]];
...
+ (void) shadowObject: (id) anObject withMock: (id) mock {
	...
	[_OCPartialMockShadowObjects setObject:mock forKey: [NSString stringWithCString:object_getClassName(anObject) encoding:NSASCIIStringEncoding]];
}
