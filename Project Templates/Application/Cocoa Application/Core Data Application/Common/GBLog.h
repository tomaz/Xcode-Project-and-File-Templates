...
// Our DDLog extensions

@interface DDLog (GBLogExtensions)
...
// Our protocol - this is a hack to allow DDLog isRegisteredClass: accept our classes...

@protocol GBDynamicLogger <NSObject>
